...
## My Interests in NLP
1. Is embedding good enough to represent semantic? can we find other approaches to replace embedding? I don't that embedding is not good enough, at least it can be promoted.
