...
## My Interests in NLP
1. Does embedding good enough? can we find other approaches to represent semantic?
2. Does RNN includes biological meanings? Can biology neural system based NLP model just like convolution.
## NLP Tasks
