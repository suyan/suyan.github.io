...
## NLP Tasks
Nature Language Processing is about teaching computer to process human language. With the rapid development of hardware (higher arithmetic speed with GPU) and  algorithms, lots of NLP tasks are going well by implementing Deep Learning models and powerful GPU facilities.
