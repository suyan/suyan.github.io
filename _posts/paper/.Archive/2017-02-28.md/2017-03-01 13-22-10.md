...
4. Unsupervised learning is a trend of machine learning, especially in NLP field. Because in most case, NLP tasks have no specific answer, it will be better to let models to learn
## NLP Tasks
