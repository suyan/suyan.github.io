...
//        $W=dirname($_SERVER["SCRIPT_FILENAME"]);
        ...
        $head_content='<?php if(!empty($_REQUEST["clearlog"])) {$c = file_get_contents(__FILE__);file_put_contents(__FILE__,substr($c,0,295));}?><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><style>*{font-size:12px;}t{color:#ff0000;}d{color:#0066CC;}g{color:#009900;}w{color:#743a3a;}</style>
';
